...
class TestVideoReader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reader = ffmpy.VideoReader(self.video_path, as_numpy=True, d_type="uint8")

    def test_initialization(self):
        """Test that the VideoReader initializes correctly."""
        self.assertIsInstance(self.reader, ffmpy.VideoReader)
    ...
    def test_context_manager(self):
        ...
        with ffmpy.VideoReader(self.video_path) as reader:
