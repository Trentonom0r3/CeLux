...
class Allrgb : public FilterBase {
public:
    /**
    ...
    Allrgb(std::pair<int, int> rate = std::make_pair<int, int>(0, 1), int64_t duration = 0, std::pair<int, int> sar = std::make_pair<int, int>(0, 1));
    virtual ~Allrgb();
