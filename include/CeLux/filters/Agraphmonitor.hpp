...
class Agraphmonitor : public FilterBase {
public:
    /**
    ...
    Agraphmonitor(std::pair<int, int> size = std::make_pair<int, int>(0, 1), float opacity = 0.90, int mode = 0, int flags = 1, std::pair<int, int> rate = std::make_pair<int, int>(0, 1));
    virtual ~Agraphmonitor();
