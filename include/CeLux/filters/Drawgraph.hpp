...
class Drawgraph : public FilterBase {
public:
    /**
    ...
    Drawgraph(const std::string& m1 = "", const std::string& fg1 = "0xffff0000", const std::string& m2 = "", const std::string& fg2 = "0xff00ff00", const std::string& m3 = "", const std::string& fg3 = "0xffff00ff", const std::string& m4 = "", const std::string& fg4 = "0xffffff00", const std::string& bg = "white", float min = -1.00, float max = 1.00, int mode = 2, int slide = 0, std::pair<int, int> size = std::make_pair<int, int>(0, 1), std::pair<int, int> rate = std::make_pair<int, int>(0, 1));
    virtual ~Drawgraph();
